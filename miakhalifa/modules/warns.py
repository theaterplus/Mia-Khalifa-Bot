...
from miakhalifa import dispatcher, BAN_STICKER
from miakhalifa.modules.disable import DisableAbleCommandHandler
from miakhalifa.modules.helper_funcs.chat_status import (is_user_admin, bot_admin, user_admin_no_reply, user_admin,
                                                     can_restrict)
from miakhalifa.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from miakhalifa.modules.helper_funcs.filters import CustomFilters
from miakhalifa.modules.helper_funcs.misc import split_message
from miakhalifa.modules.helper_funcs.string_handling import split_quotes
from miakhalifa.modules.log_channel import loggable
from miakhalifa.modules.sql import warns_sql as sql
...
def warn(user: User, chat: Chat, reason: str, message: Message, warner: User = None) -> str:
    ...
    if num_warns >= limit:
        ...
        keyboard = InlineKeyboardMarkup([{InlineKeyboardButton("Remove warn [Admins Only]",
